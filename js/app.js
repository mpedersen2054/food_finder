        ...
        getPlaces: function(locData) {
            ...
            function getQueryString() {
                var params = locData,
                    ...
                    state = params[2],
                    qString = 'https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20local.search(20)%20where%20query%3D%22'+food+'%22%20and%20location%3D%22'+city+'%2C%20'+state+'%22&format=json&diagnostics=true&callback='
